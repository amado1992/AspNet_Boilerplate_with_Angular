        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ActivityTodayId = table.Column<int>(type: "int", nullable: true),
                    DanceTypeId = table.Column<int>(type: "int", nullable: true),
                    ...
                    BaseFeeId = table.Column<int>(type: "int", nullable: true),
                    QuotaPaid = table.Column<double>(type: "float", nullable: true),
                    FeePayable = table.Column<double>(type: "float", nullable: true),
                    IsActiveDance = table.Column<bool>(type: "bit", nullable: false),
                    CustomerDanceFees = table.Column<double>(type: "float", nullable: true),
                    PercentExpose = table.Column<double>(type: "float", nullable: true),
                    PercentEntertainer = table.Column<double>(type: "float", nullable: true),
                    TimeDance = table.Column<int>(type: "int", nullable: true),
                    CountDanceBySong = table.Column<int>(type: "int", nullable: true),
                    TimeDanceDefault = table.Column<int>(type: "int", nullable: true),
                    CountDanceBySongDefault = table.Column<int>(type: "int", nullable: true),
                    QuotaPaidTotal = table.Column<double>(type: "float", nullable: true),
                    FeePayableTotal = table.Column<double>(type: "float", nullable: true),
                    PercentExposeTotal = table.Column<double>(type: "float", nullable: true),
                    PercentEntertainerTotal = table.Column<double>(type: "float", nullable: true),
                    DanceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CodeDance = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Before = table.Column<int>(type: "int", nullable: true),
                    Between = table.Column<int>(type: "int", nullable: true),
                    After = table.Column<int>(type: "int", nullable: true),
                    Background = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraShift = table.Column<bool>(type: "bit", nullable: false),
                    StartExtraShift = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DanceBases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DanceTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentsWhite", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HiredStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DLState = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Managers_Categorys_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainBusinessElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainBusinessElements_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DanceTypeId = table.Column<int>(type: "int", nullable: false),
                    CountDanceBySong = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongDanceTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SongDanceTypes_DanceTypes_DanceTypeId",
                        column: x => x.DanceTypeId,
                        principalTable: "DanceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SongDanceTypes_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdultPermitNum = table.Column<int>(type: "int", nullable: false),
                    ...
                    DateHired = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CategoryId = table.Column<int>(type: "int", nullable: true),
                    HiredById = table.Column<int>(type: "int", nullable: true),
                    NoHiredById = table.Column<int>(type: "int", nullable: true),
                    HiredStatuId = table.Column<int>(type: "int", nullable: true),
                    TerminatedHired = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SSN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entertainers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Entertainers_Categorys_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categorys",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entertainers_Clubs_ClubId",
                        column: x => x.ClubId,
                        principalTable: "Clubs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entertainers_HiredStatus_HiredStatuId",
                        column: x => x.HiredStatuId,
                        principalTable: "HiredStatus",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entertainers_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entertainers_Managers_HiredById",
                        column: x => x.HiredById,
                        principalTable: "Managers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entertainers_Managers_NoHiredById",
                        column: x => x.NoHiredById,
                        principalTable: "Managers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "SubBusinessElements",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MainBusinessElementId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubBusinessElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubBusinessElements_MainBusinessElements_MainBusinessElementId",
                        column: x => x.MainBusinessElementId,
                        principalTable: "MainBusinessElements",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "WaitressRevenues",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaitressRevenues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WaitressRevenues_MainBusinessElements_MainBusinessElementId",
                        column: x => x.MainBusinessElementId,
                        principalTable: "MainBusinessElements",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Output = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityTodays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivityTodays_Entertainers_EntertainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_Entertainers_EntertainerId",
                        column: x => x.EntertainerId,
                        principalTable: "Entertainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MainBusinessElementId = table.Column<int>(type: "int", nullable: true),
                    SubBusinessElementId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeBusinessElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TypeBusinessElements_MainBusinessElements_MainBusinessElementId",
                        column: x => x.MainBusinessElementId,
                        principalTable: "MainBusinessElements",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TypeBusinessElements_SubBusinessElements_SubBusinessElementId",
                        column: x => x.SubBusinessElementId,
                        principalTable: "SubBusinessElements",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "FloorDanceTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FloorDanceTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FloorDanceTypes_ActivityTodays_ActivityTodayId",
                        column: x => x.ActivityTodayId,
                        principalTable: "ActivityTodays",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FloorDanceTypes_DanceTypes_DanceTypeId",
                        column: x => x.DanceTypeId,
                        principalTable: "DanceTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FloorDanceTypes_Key_KeyId",
                        column: x => x.KeyId,
                        principalTable: "Key",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FloorDanceTypes_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypeBusinessElementId = table.Column<int>(type: "int", nullable: true),
                    WaitressRevenuesId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounting_Shifts_ShiftId",
                        column: x => x.ShiftId,
                        principalTable: "Shifts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Accounting_TypeBusinessElements_TypeBusinessElementId",
                        column: x => x.TypeBusinessElementId,
                        principalTable: "TypeBusinessElements",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Accounting_WaitressRevenues_WaitressRevenuesId",
                        column: x => x.WaitressRevenuesId,
                        principalTable: "WaitressRevenues",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypeBusinessElementId = table.Column<int>(type: "int", nullable: false),
                    ShiftId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceShifts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PriceShifts_Key_KeyId",
                        column: x => x.KeyId,
                        principalTable: "Key",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PriceShifts_Shifts_ShiftId",
                        column: x => x.ShiftId,
                        principalTable: "Shifts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PriceShifts_TypeBusinessElements_TypeBusinessElementId",
                        column: x => x.TypeBusinessElementId,
                        principalTable: "TypeBusinessElements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounting_ShiftId",
                table: "Accounting",
                column: "ShiftId");

            migrationBuilder.CreateIndex(
                name: "IX_Accounting_TypeBusinessElementId",
                table: "Accounting",
                column: "TypeBusinessElementId");

            migrationBuilder.CreateIndex(
                name: "IX_Accounting_WaitressRevenuesId",
                table: "Accounting",
                column: "WaitressRevenuesId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityTodays_EntertainerId",
                table: "ActivityTodays",
                column: "EntertainerId");

            migrationBuilder.CreateIndex(
                name: "IX_Documents_EntertainerId",
                table: "Documents",
                column: "EntertainerId");

            migrationBuilder.CreateIndex(
                name: "IX_Entertainers_CategoryId",
                table: "Entertainers",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Entertainers_ClubId",
                table: "Entertainers",
                column: "ClubId");

            migrationBuilder.CreateIndex(
                name: "IX_Entertainers_HiredById",
                table: "Entertainers",
                column: "HiredById");

            migrationBuilder.CreateIndex(
                name: "IX_Entertainers_HiredStatuId",
                table: "Entertainers",
                column: "HiredStatuId");

            migrationBuilder.CreateIndex(
                name: "IX_Entertainers_JobId",
                table: "Entertainers",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_Entertainers_NoHiredById",
                table: "Entertainers",
                column: "NoHiredById");

            migrationBuilder.CreateIndex(
                name: "IX_FloorDanceTypes_ActivityTodayId",
                table: "FloorDanceTypes",
                column: "ActivityTodayId");

            migrationBuilder.CreateIndex(
                name: "IX_FloorDanceTypes_DanceTypeId",
                table: "FloorDanceTypes",
                column: "DanceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_FloorDanceTypes_KeyId",
                table: "FloorDanceTypes",
                column: "KeyId");

            migrationBuilder.CreateIndex(
                name: "IX_FloorDanceTypes_ShiftId",
                table: "FloorDanceTypes",
                column: "ShiftId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainBusinessElements_SectionId",
                table: "MainBusinessElements",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Managers_JobId",
                table: "Managers",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceShifts_KeyId",
                table: "PriceShifts",
                column: "KeyId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceShifts_ShiftId",
                table: "PriceShifts",
                column: "ShiftId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceShifts_TypeBusinessElementId",
                table: "PriceShifts",
                column: "TypeBusinessElementId");

            migrationBuilder.CreateIndex(
                name: "IX_SongDanceTypes_DanceTypeId",
                table: "SongDanceTypes",
                column: "DanceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SongDanceTypes_SongId",
                table: "SongDanceTypes",
                column: "SongId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubBusinessElements_MainBusinessElementId",
                table: "SubBusinessElements",
                column: "MainBusinessElementId");

            migrationBuilder.CreateIndex(
                name: "IX_TypeBusinessElements_MainBusinessElementId",
                table: "TypeBusinessElements",
                column: "MainBusinessElementId");

            migrationBuilder.CreateIndex(
                name: "IX_TypeBusinessElements_SubBusinessElementId",
                table: "TypeBusinessElements",
                column: "SubBusinessElementId");

            migrationBuilder.CreateIndex(
                name: "IX_WaitressRevenues_MainBusinessElementId",
                table: "WaitressRevenues",
                column: "MainBusinessElementId");
        }
