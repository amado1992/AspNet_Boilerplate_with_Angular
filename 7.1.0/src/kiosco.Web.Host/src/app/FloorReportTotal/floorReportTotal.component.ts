...
@Component({
    selector: 'app-floorReportTotal',
    templateUrl: './floorReportTotal.component.html',
    styleUrls: ['./floorReportTotal.component.css']
})

export class FloorReportTotalComponent extends AppComponentBase implements OnInit, OnChanges {
    entityDto: any
