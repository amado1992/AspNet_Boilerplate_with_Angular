...
import { ClubDto } from '../../shared/entities/club';
import { HttpErrorResponse } from '@angular/common/http';

@Component({
    selector: 'app-clubCE',
    templateUrl: './clubCE.component.html',
    styleUrls: ['./clubCE.component.css']
})

export class ClubCEComponent extends AppComponentBase implements OnInit {
    entityDto: ClubDto
    ...
    save(): void {
        ...
        if (this.entityDto.id == 0) {
            ...
            this.appBaseService.create('Club', this.entityDto)
                .subscribe(response => {
            ...
            this.appBaseService.update('Club', this.entityDto)
                .subscribe(response => {
                    this.isLoadingResults = false
