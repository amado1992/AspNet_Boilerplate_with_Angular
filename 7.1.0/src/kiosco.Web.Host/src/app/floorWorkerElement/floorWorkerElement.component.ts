...
@Component({
    selector: 'app-floorWorker-element',
    templateUrl: './floorWorkerElement.component.html',
    styleUrls: ['./floorWorkerElement.component.css'],
    animations: [appModuleAnimation()]
})

export class FloorWorkerElementComponent extends AppComponentBase implements OnInit, AfterViewInit, DoCheck {
    totalRows = 0;
    pageSize = 10;
    currentPage = 0;
