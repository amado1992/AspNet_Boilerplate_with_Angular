...
import { EntertainerDto } from '@shared/entities/entertainer';
import { HttpErrorResponse } from '@angular/common/http';

@Component({
    selector: 'app-entertainerCE',
    templateUrl: './entertainerCE.component.html',
    styleUrls: ['./entertainerCE.component.css']
})

export class EntertainerCEComponent extends AppComponentBase implements OnInit {
    entityDto: EntertainerDto
    clubsResults: any[] = []
    jobsResults: any[] = []
    ...
    constructor(injector: Injector, public dialogRef: MatDialogRef<any>,
        ...
        if (data.entity != null) {
            ...
            this.entityDto = new EntertainerDto();
    ...
    save(): void {
        ...
        if (this.entityDto.id == 0) {
            ...
            this.appBaseService.create('Entertainer', this.entityDto)
                .subscribe(response => {
            ...
            this.appBaseService.update('Entertainer', this.entityDto)
                .subscribe(response => {
                    this.isLoadingResults = false
    ...
    updateForm() {
        this.form.patchValue({
            adultPermitNum: this.entityDto.adultPermitNum,
            permitExpires: this.entityDto.permitExpires,
            contractExpires: this.entityDto.contractExpires,
            ...
            //new field
            stageName: this.entityDto.stageName,
            corporateId: this.entityDto.corporateId,
            dateHired: this.entityDto.dateHired,
            categoryId: this.entityDto.categoryId,
            hiredById: this.entityDto.hiredById,
            //terminated contract
            noHiredById: this.entityDto.noHiredById,
            hiredStatuId: this.entityDto.hiredStatuId,
            terminatedHired: this.entityDto.terminatedHired,
        });
    }
    ...
    loadContractors() {
        this.appBaseService.list('Manager', 0, 200000)
            .subscribe(response => {
                if (response.result) {
