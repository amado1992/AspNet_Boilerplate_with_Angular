...
import { SongDanceTypeCEComponent } from "../songDanceType/songDanceTypeCE.component";
import { AppComponentBase } from '../../shared/app-component-base';
import { HttpErrorResponse } from '@angular/common/http';

@Component({
    selector: 'app-songdancetype',
    templateUrl: './songDanceType.component.html',
    styleUrls: ['./songDanceType.component.css'],
    animations: [appModuleAnimation()]
})

export class SongDanceTypeComponent extends AppComponentBase implements OnInit, AfterViewInit {
    totalRows = 0;
    pageSize = 10;
    currentPage = 0;
    ...
    displayedColumns = ['songTitle', 'danceTypeTitle', 'countDanceBySong', 'actions'];
    ...
    openCreateDialog(): void {
        ...
        let dialogRef = this.dialog.open(SongDanceTypeCEComponent, config);
    ...
    onDeleteClick(entry): void {
        abp.message.confirm("Are you sure you want to delete this information?.",
            ...
            (result: boolean) => {
                if (result) {
                    this.appBaseService.delete("SongDanceType", entry)
                        .subscribe(response => {
                            if (response.success) {
    ...
    loadData() {
        ...
        this.appBaseService.list('SongDanceType', this.currentPage * this.pageSize, this.pageSize, this.filter, this.order)
            .subscribe(response => {
                if (response.result) {
