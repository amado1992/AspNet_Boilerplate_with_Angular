...
@Component({
    selector: 'app-activityToday',
    templateUrl: './activityToday.component.html',
    styleUrls: ['./activityToday.component.css'],
    animations: [appModuleAnimation()]
})

export class ActivityTodayComponent extends AppComponentBase implements OnInit, AfterViewInit {
    totalRows = 0;
    pageSize = 10;
    currentPage = 0;
    ...
    displayedColumns = ['entertainerFirstName', 'entertainerLastName', 'entertainerMobilePhone', 'isActive', 'input', 'output', 'actions'];
    ...
    loadData() {
        ...
        this.appBaseService.list('ActivityToday', this.currentPage * this.pageSize, this.pageSize, this.filter, this.order)
            .subscribe(response => {
                if (response.result) {
