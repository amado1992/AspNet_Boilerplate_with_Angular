...
import { WaitressRevenuesDto } from '../../shared/entities/waitress-revenues';
import { HttpErrorResponse } from '@angular/common/http';

@Component({
    selector: 'app-waitress-revenuesCE',
    templateUrl: './waitress-revenuesCE.component.html',
    styleUrls: ['./waitress-revenuesCE.component.css']
})

export class WaitressRevenuesCEComponent extends AppComponentBase implements OnInit {
    entityDto: WaitressRevenuesDto
    ...
    constructor(injector: Injector, public dialogRef: MatDialogRef<any>,
        ...
        if (data.entity != null) {
            ...
            this.entityDto = new WaitressRevenuesDto();
    ...
    save(): void {
        ...
        if (this.entityDto.id == 0) {
            ...
            this.appBaseService.create('WaitressRevenues', this.entityDto)
                .subscribe(response => {
            ...
            this.appBaseService.update('WaitressRevenues', this.entityDto)
                .subscribe(response => {
                    this.isLoadingResults = false
