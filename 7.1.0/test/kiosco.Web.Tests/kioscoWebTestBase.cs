...
{
    public abstract class kioscoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static kioscoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(kioscoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<kioscoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<kioscoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<kioscoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<kioscoDbContext, Task<T>> func)
        {
            T result;
